            ...
            VStack(spacing: 24) {
                ...
                HStack {
                    ...
                    Button(action: {
                        ...
                        Text(currentStep == totalSteps - 1 ? "Start Unlockly" : "Continue")
                            .fontWeight(.bold)
                            ...
                            .foregroundColor(isCurrentStepValid ? .white : Color(red: 148/255.0, green: 163/255.0, blue: 184/255.0))
                            .cornerRadius(12)
                    }
            ...
            VStack(alignment: .leading, spacing: 8) {
                ...
                .overlay(
                    RoundedRectangle(cornerRadius: 12)
                        .stroke(isValid ? Color.green : (length > 0 ? Color.orange : Color(red: 51/255.0, green: 65/255.0, blue: 85/255.0)), lineWidth: 1)
                )
...
struct ScreenTimeSetupStepView: View {
    ...
    var body: some View {
        VStack(spacing: 20) {
            ...
            Text("Unlockly uses Apple Screen Time APIs to track study progress and shield social apps.")
                .font(.subheadline)
                .multilineTextAlignment(.center)
                .foregroundColor(Color(red: 148/255.0, green: 163/255.0, blue: 184/255.0))
                .padding(.horizontal, 24)
