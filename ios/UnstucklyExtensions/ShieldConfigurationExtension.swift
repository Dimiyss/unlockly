...
class UnstucklyShieldConfiguration: ShieldConfigurationDataSource {
    override func configuration(shielding application: Application) -> ShieldConfiguration {
        return ShieldConfiguration(
            ...
            subtitle: ShieldConfiguration.Label(
                text: "Your social wallet is empty. Earn time by studying, or enter your 35+ symbol emergency passphrase in Unstuckly to override.",
