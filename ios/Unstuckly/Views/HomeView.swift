                ...
                ScrollView {
                    VStack(spacing: 20) {
                        ...
                        HStack {
                            ...
                            Button(action: { isPreferencesPresented = true }) {
                        ...
                        VStack(alignment: .leading, spacing: 10) {
                            ...
                            HStack {
                                Text("\(studiedSeconds / 60)m / \(targetMinutes)m required")
                                    .font(.caption)
                                    .foregroundColor(isCompleted ? Color(red: 16/255.0, green: 185/255.0, blue: 129/255.0) : Color.appTextSecondary)
                            ...
                            HStack {
                                ...
                                VStack(alignment: .leading, spacing: 2) {
                                    ...
                                    Text(walletManager.wallet.emergencyUnlockUsedToday ? "Used today (resets at midnight)" : "Override shields with 35+ symbol passphrase (1x / day)")
                                        .font(.caption)
                                        .foregroundColor(walletManager.wallet.emergencyUnlockUsedToday ? .orange : Color.appTextSecondary)
                                }
