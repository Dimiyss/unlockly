...
struct ProHeroCard: View {
    ...
    var body: some View {
        VStack(spacing: 16) {
            ...
            Text(isPro ? "You Are a PRO Member!" : "Unstuckly PRO")
                .font(.title)
                .fontWeight(.heavy)
                .foregroundColor(.appTextPrimary)
...
struct PlanButton: View {
    ...
    var body: some View {
        Button(action: onSelect) {
            ...
            .frame(maxWidth: .infinity)
            .padding(12)
            .background(isSelected ? Color(red: 99/255.0, green: 102/255.0, blue: 241/255.0).opacity(0.2) : Color.appBackground)
            .cornerRadius(14)
            .overlay(
                RoundedRectangle(cornerRadius: 14)
                    .stroke(isSelected ? Color(red: 99/255.0, green: 102/255.0, blue: 241/255.0) : Color.appBorder, lineWidth: isSelected ? 2 : 1)
            )
        }
    }
}
